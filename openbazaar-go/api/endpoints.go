...
func post(i *jsonAPIHandler, path string, w http.ResponseWriter, r *http.Request) {
	...
	case strings.HasPrefix(path, "/ob/profile"):
		i.POSTProfile(w, r)
	//added by ChenYang
	case strings.HasPrefix(path, "/ob/add"):
		i.POSTAdd(w, r)
...
func get(i *jsonAPIHandler, path string, w http.ResponseWriter, r *http.Request) {
	...
	//added by ChenYang 2018-02-26 17:53:00 start
	case strings.HasPrefix(path, "/ob/cat"):
		i.GETContent(w, r)
	case strings.HasPrefix(path, "/ob/file"):
		i.GETFile(w, r)
	//added by ChenYang 2018-02-26 17:53:00 end
